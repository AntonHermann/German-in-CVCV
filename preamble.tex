...
\newenvironment{structure}[2][1.5]{ % args: [node_dist] subtext
  ...
  %
  \pgfkeys{/tikz/.cd, % set the path
    skeleton name/.initial={INIT},
    skeleton name/.get=\skeletonnodename,
    skeleton name/.store in=\skeletonnodename,
    n/.forward to=tikz/skeleton name,
    gov/.initial={},
    gov/.get=\structureRelationGov,
    gov/.store in=\structureRelationGov,
    gov/.default=true,
  ...
  \newcommand\emptyV[1][]{ % optionally pass 'gov' or 'nogov'
    ...
    \StructureHandleSkeletonNode{V}{##1}
    \stepcounter{vowel}
    \ifdefstring{\structureRelationGov}{true}{\Gov{V\thevowel}{\prevpos}}{}
    \ifdefstring{\structureRelationGov}{false}{\NoGov{V\thevowel}{\prevpos}}{}
  }
  \newcommand\emptyC{
