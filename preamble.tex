...
\newenvironment{structure}[2][1.5]{ % args: [node_dist] subtext
  ...
  \newcommand\wordstart{
    \def\skeletonnodename{\ifdef{\defaultskeletonnodename}{\defaultskeletonnodename}{0}}
    \node (C0) at (0       , 0) {$C_\text{\skeletonnodename}$};
    \node (V0) at (0.5 * #1, 0) {$V_\text{\skeletonnodename}$};
