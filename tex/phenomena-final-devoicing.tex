...
where it makes obstruents \tr{voiceless}.
...
\cite{scheer2004} \tr{brings forth} a number of arguments
...
and -- depending on the lateral actorship of \gls{FEN} --
...
that the |g| is \tr{underlying} and \ex{Jagden} shows
