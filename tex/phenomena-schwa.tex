...
first notes that because of the realted words \ex{Händler} and \ex{Handlung}
the root must contain a Schwa mobile. To this root the \tr{suffices}
\ex{-\schwaMobi{}n} and \ex{-\schwaMobi{}s} are added and the
Schwa mobiles are resolved as follows:
\begin{enumerate}
  % shortcuts for suffices -en, -es
...
\begin{structure}
  ...
  \NoLic{V5}{C5}
\end{structure}
\TODO{What is going on with $V_2$??}
