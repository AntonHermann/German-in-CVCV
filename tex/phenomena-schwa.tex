...
\item One of these processes that ensure well-formedness in these
  ...
  it itself establishes a governing relationship.
  \TODO{Vorsicht: governed den Nucleus, aber kann dieser governen?}
  The notion of
  \emph{being licensed to be empty} known from \SGP is discarded
  by \cite{scheer2004}.}
\end{enumerate}
...
If both assumptions are \tr{satisfied? true?}, \ex{Handlung}
