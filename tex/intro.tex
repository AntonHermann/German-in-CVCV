...
\Gls{GP} assumes that the primary relations that define
...
\footnotetext{\Cref{subsec:intro:gov lic in SGP} introduces concepts
that are immediately discarded again in the following. Its purpose is
merely to highlight the changes introduced in \cite{scheer2004}.
In order to follow along, the chapter can be skipped safely.}