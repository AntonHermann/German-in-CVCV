...
If $V_1$ is the head, $V_2$ needs licensing support from a following
laterally enabled Nucleus. Vowel length alternations are one of the
phenomena ascribed to varying external licensing support of
left-headed long vowels.
If however $V_2$ is the head, it can license its complement $V_1$
and the long vowel is self-sufficient.
